var questions = [{ 
	...
	title: 'What color is Sailor Mars?',
	answers: ['Red', 'Green', 'Orange', 'Yellow'],
	correct: 0
},
{
	title: 'What color is Sailor Jupiter?',
	answers: ['Red', 'Green', 'Orange', 'Yellow'],
	correct: 1
},
{
	title: 'What color is Venus?',
	answers: ['Red', 'Green', 'Orange', 'Yellow'],
	correct: 2
},
{
	title: 'What color is Sailor Saturn',
	answers: ['Red', 'Green', 'Orange', 'Yellow'],
	correct: 3
}];
